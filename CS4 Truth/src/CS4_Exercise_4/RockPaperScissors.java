...
public class RockPaperScissors{
	public static void main(String[] args){
		...
		System.out.printf("Welcome to Rock, Paper, Scissors. Please choose an option: %n 1. Start game %n 2. Change number of rounds %n 3. Exit application %n" );
		...
		if (choice.equals("1")){
			...
			do{
				...
				//displays the result and increments the score for both
				if (result == 0){
